...
python3 -m rv_logbook trip-export-bundle <trip-slug> --mode current --base-dir data
python3 -m rv_logbook trip-export-bundle <trip-slug> --mode final --base-dir data
```
